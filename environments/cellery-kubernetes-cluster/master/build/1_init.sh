...
install_cellery(){
    wget --directory-prefix=${TEMP_DIR} https://github.com/wso2-cellery/sdk/releases/download/v0.5.0/cellery-ubuntu-x64-0.5.0.deb
    sudo dpkg -i ${TEMP_DIR}/cellery-ubuntu-x64-0.5.0.deb
